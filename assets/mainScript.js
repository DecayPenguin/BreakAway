...
$(document).ready(function () {
    ...
    // onclick of a button that is taking the value the input field (zipcode), then need to pass that value(zipcode) into Function getEvents -- 
    //input class="file-path validate" from "lets see what around you"
